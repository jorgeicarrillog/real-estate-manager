...
class OrganizationsController extends Controller
{
    ...
    public function edit(Organization $organization)
    {
        ...
        return Inertia::render('Organizations/Edit', [
            ...
            'properties' => $organization->properties()->withTrashed()->orderBy('updated_at', 'desc')->orderBy('created_at', 'desc')->with('propertiesType', 'citie.department.countrie')->paginate(15),
        ]);
    }
